...
function classify_point(x, y) {
(() => {
const _matched = [x, y];
if ((Array.isArray(_matched) && _matched.length === 2 && _matched[0] === 0 && _matched[1] === 0)) {
return "origin";
} else if ((Array.isArray(_matched) && _matched.length === 2 && _matched[0] === 0)) {
return "on y-axis";
} else if ((Array.isArray(_matched) && _matched.length === 2 && _matched[1] === 0)) {
return "on x-axis";
} else if (true) {
return "elsewhere";
}
...
function main() {
void (println(`(0, 0): ${classify_point(0, 0)}`));void (println(`(0, 5): ${classify_point(0, 5)}`));void (println(`(3, 0): ${classify_point(3, 0)}`));void (println(`(3, 4): ${classify_point(3, 4)}`));
};
