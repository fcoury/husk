...
function main() {
  ...
  void (console.log(`Import maps demo with React state: ${state}`));
  let debounced_fn = debounce(() => (() => {
    void (console.log("Debounced function called"))
  })(), 300);
  void (console.log("Axios available for HTTP requests"));
  void (console.log("Import maps successfully mapped packages to custom URLs!"));
}
