...
Command.Exit = class extends Command {constructor(value) { super('Exit', value); }};
Command.Exit = new Command.Exit();
Command.Process = class extends Command {constructor(value) { super('Process', value); }};
;
function main() {
let cmd1 = Command.Exit;let cmd2 = (function() {const __INSTANCE__ = Object.create(Command.Process.prototype);__INSTANCE__.input = "test.txt";__INSTANCE__.output = "out.txt";return __INSTANCE__;})();return (() => {
const _matched = cmd2;
if (_matched === Command.Exit) {
return println("Exit");
} else if (_matched instanceof Command.Process) {
const input = _matched.input;
const output = _matched.output;
return println(`Process ${input} to ${output}`);
}
})();
};
