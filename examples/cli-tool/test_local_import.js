...
import { log_info, log_error, normalize_path } from './simple_utils.js';
export function main() {
void (log_info("Testing local imports"));let path = normalize_path("//home//user//file.txt");void (log_info(`Normalized path: ${path}`));void (log_error("This is an error message"));
};
